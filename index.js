...
function iniciar()
  {
    ...
    onOff= false; //true pa pausar  el juegp
    velocidad = 500;
    comidasConsumidas = 0;
...
document.getElementById('modoOscuroBtn').addEventListener('click', modoOscuro);

document.getElementById('botonArriba').addEventListener('click', function() {
    if (direccion !== "ArrowDown") direccion = "ArrowUp";
});
document.getElementById('botonAbajo').addEventListener('click', function() {
...
document.getElementById('botonDerecha').addEventListener('click', function() {
    if (direccion !== "ArrowLeft") direccion = "ArrowRight";
});
